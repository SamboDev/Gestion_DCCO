					...
					<table class="table table-bordered table-sm">
						<thead class="thead">
							<tr> 
								...
								<th>Codigo Mat</th>
								<th>Nombre Mat</th>
								<th>Requisito Doc Mat</th>
								<th>Horas Trabauto Mat</th>
								<th>Horas Doc Mat</th>
								<th>Horas Invest Mat</th>
								<th>Horas Total</th>
								<th>Descripcion Mat</th>
								<td>ACTIONS</td>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td>{{ $row->id_are }}</td>
								<td>{{ $row->codigo_mat }}</td>
								<td>{{ $row->nombre_mat }}</td>
								<td>{{ $row->requisito_doc_mat }}</td>
								<td>{{ $row->horas_trabAuto_mat }}</td>
								<td>{{ $row->horas_doc_mat }}</td>
								<td>{{ $row->horas_invest_mat }}</td>
								<td>{{ $row->horas_total }}</td>
								<td>{{ $row->descripcion_mat }}</td>
								<td width="90">
									<div class="dropdown">
