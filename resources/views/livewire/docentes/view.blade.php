					...
					<table class="table table-bordered table-sm">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $row->id_curri }}</td>
								<td>{{ $row->nombre_doc }}</td>
								<td>{{ $row->apellido_doc }}</td>
								<td>{{ $row->cedula_doc }}</td>
								<td>{{ $row->fecha_nac_doc }}</td>
								<td>{{ $row->direccion_doc }}</td>
								<td>{{ $row->correo_doc }}</td>
								<td>{{ $row->telefono_doc }}</td>
								<td width="90">
									<div class="dropdown">
